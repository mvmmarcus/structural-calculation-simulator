  ...
  return (
    <>
      ...
      <Grid item xs={6}>
        <Input
          error={
            formik.touched.carga_distribuida && formik.errors.carga_distribuida
          }
          handleChange={handleChange}
      ...
      <Grid item xs={6}>
        <Input
          error={formik.touched.comp_arame_bc && formik.errors.comp_arame_bc}
          handleChange={handleChange}
      ...
      <Grid item xs={6}>
        <Input
          error={formik.touched.comp_arame_de && formik.errors.comp_arame_de}
          handleChange={handleChange}
